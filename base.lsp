...
(defun AddRectang(pt1 pt2 pwidth)
	(entmakex(list(cons 0 "LWPOLYLINE")(cons 100 "AcDbEntity")(cons 100 "AcDbPolyline")
					(cons 90 4)(cons 210 (getvar "VIEWDIR"))(cons 40 pwidth)(cons 41 pwidth)(cons 43 pwidth) (cons 10 pt1)(cons 10 pt2)
						 (cons 10 (list (car pt1) (cadr pt2)(caddr pt1)))(cons 10 (list (car pt2)(cadr pt1)(caddr pt2)))))
)
